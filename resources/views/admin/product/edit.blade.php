...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h3 class="page-title">
            Product Edit <span class="badge"></span>
            </h3>
            <div class="row">
                <div class="col-md-12">
                    <!-- BORDERED TABLE -->
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="stock" id="stock" type="checkbox" data-toggle="toggle" data-on="Yes" data-off="No" {{ $product->stock == 1 ? 'checked' : '' }}>  
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Product Description</label>
                                            <textarea name="description" id="description" cols="30" rows="15">{{ $product->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            type="text" value="{{ $product->present_price }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            type="text" value="{{ $product->previous_price }}">
                                        </div>
